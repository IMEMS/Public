...
// Assigns port,pin and peripheral definitions depending on the MCU in use
	...
	// UART Communication
	// UART ICDI Virtual COM Port
	#define TWE_VCOM_PERIPH					SYSCTL_PERIPH_UART0
	#define TWE_VCOM_BASE					UART0_BASE
	#define TWE_VCOM_GPIO_PERIPH			SYSCTL_PERIPH_GPIOA
	#define TWE_VCOM_GPIO_BASE				GPIO_PORTA_BASE
	#define TWE_VCOM_RX_PIN_CONFIG			GPIO_PA0_U0RX
	#define TWE_VCOM_TX_PIN_CONFIG			GPIO_PA1_U0TX
	#define TWE_VCOM_RX_PIN					GPIO_PIN_0
	#define TWE_VCOM_TX_PIN					GPIO_PIN_1
	#define TWE_VCOM_UDMA_RX_CHANNEL 		UDMA_CHANNEL_UART0RX
	#define TWE_VCOM_UDMA_TX_CHANNEL 		UDMA_CHANNEL_UART0TX
	// UART PC Fast Comm
...
// UART VCOM
extern void twe_initVCOM(uint32_t SysClkFreq, uint32_t baudRate);
// UART Fast to PC
